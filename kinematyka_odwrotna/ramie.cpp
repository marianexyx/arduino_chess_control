...
void cRamie::Open() 
{
  ...
  _pSilnikE->UstawKat(nSzczekiOtwarte); _pLCD_angle->PrintAngle("servoE", servoE.getKat() );
  _pSilnikF->UstawKat(200 - nSzczekiOtwarte); _pLCD_angle->PrintAngle("servoF", servoF.getKat() );
...
void cRamie::Close() 
{
  ...
  _pSilnikE->UstawKat(nSzczekiZamkniete); _pLCD_angle->PrintAngle("servoE", servoE.getKat() );
  _pSilnikF->UstawKat(200 - nSzczekiZamkniete); _pLCD_angle->PrintAngle("servoF", servoF.getKat() );
